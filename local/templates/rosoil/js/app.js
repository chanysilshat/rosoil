(() => {
    ...
    function C(e) {
        return function (...t) {
            if (void 0 === t[0]) {
                for (let t = 0; t < this.length; t += 1) S.indexOf(e) < 0 && (e in this[t] ? this[t][e]() : y(this[t]).trigger(e));
                return this;
            }
            return this.on(e, ...t);
        };
    ...
    const E = {
        ...
        append: function (...e) {
            ...
            for (let i = 0; i < e.length; i += 1) {
                ...
                for (let e = 0; e < this.length; e += 1)
                    ...
                    } else if (t instanceof v) for (let s = 0; s < t.length; s += 1) this[e].appendChild(t[s]);
        ...
        prepend: function (e) {
            ...
            for (s = 0; s < this.length; s += 1)
                ...
                } else if (e instanceof v) for (i = 0; i < e.length; i += 1) this[s].insertBefore(e[i], this[s].childNodes[0]);
        ...
        for (let s = 1; s < arguments.length; s += 1) {
            ...
            if (null != i && !A(i)) {
                ...
                for (let t = 0, n = s.length; t < n; t += 1) {
                    ...
                    void 0 !== a && a.enumerable && (P(e[n]) && P(i[n]) ? (i[n].__swiper__ ? (e[n] = i[n]) : O(e[n], i[n])) : !P(e[n]) && P(i[n]) ? ((e[n] = {}), i[n].__swiper__ ? (e[n] = i[n]) : O(e[n], i[n])) : (e[n] = i[n]));
                }
            }
        }
        return e;
    ...
    const N = {
        ...
        updateClickedSlide: function (e) {
            ...
            (t.clickedSlide = i),
                t.virtual && t.params.virtual.enabled ? (t.clickedIndex = parseInt(T(i).attr("data-swiper-slide-index"), 10)) : (t.clickedIndex = n),
        ...
        translateTo: function (e, t, s, i, n) {
            ...
            if (((c = i && e > l ? l : i && e < d ? d : e), a.updateProgress(c), r.cssMode)) {
                ...
                if (0 === t) o[e ? "scrollLeft" : "scrollTop"] = -c;
                    ...
                    if (!a.support.smoothScroll) return _({ swiper: a, targetPosition: -c, side: e ? "left" : "top" }), !0;
        ...
        slideTo: function (e, t, s, i, n) {
            ...
            if (o.cssMode) {
                ...
                if (0 === t) {
                    ...
                    if (!a.support.smoothScroll) return _({ swiper: a, targetPosition: s, side: e ? "left" : "top" }), !0;
    ...
    const F = {
        loopCreate: function () {
            ...
            for (let e = r.length - 1; e >= 0; e -= 1) n.prepend(T(r[e].cloneNode(!0)).addClass(s.slideDuplicateClass));
        },
        loopFix: function () {
            const e = this;
    ...
    function W(e) {
        ...
        !!a.noSwipingClass && "" !== a.noSwipingClass && l.target && l.target.shadowRoot && e.path && e.path[0] && (d = T(e.path[0]));
        ...
        if (
            ...
            let e = !0;
            d.is(n.focusableElements) && ((e = !1), "SELECT" === d[0].nodeName && (n.isTouched = !1)), s.activeElement && T(s.activeElement).is(n.focusableElements) && s.activeElement !== d[0] && s.activeElement.blur();
    ...
    function R(e) {
        ...
        if (!s.allowTouchMove) return T(l.target).is(i.focusableElements) || (s.allowClick = !1), void (i.isTouched && (Object.assign(a, { startX: c, startY: p, currentX: c, currentY: p }), (i.touchStartTime = L())));
        ...
        if (i.isTouchEvent && t.activeElement && l.target === t.activeElement && T(l.target).is(i.focusableElements)) return (i.isMoved = !0), void (s.allowClick = !1);
        ...
        (a.diff = f), (f *= n.touchRatio), r && (f = -f), (s.swipeDirection = f > 0 ? "prev" : "next"), (i.currentTranslate = f + i.startTranslate);
        let g = !0,
            v = n.resistanceRatio;
        if (
        ...
        return function (s) {
            ...
            "object" == typeof n && null !== n
                ? (["navigation", "pagination", "scrollbar"].indexOf(i) >= 0 && !0 === e[i] && (e[i] = { auto: !0 }),
                  i in e && "enabled" in n ? (!0 === e[i] && (e[i] = { enabled: !0 }), "object" != typeof e[i] || "enabled" in e[i] || (e[i].enabled = !0), e[i] || (e[i] = { enabled: !1 }), O(t, s)) : O(t, s))
                : O(t, s);
        };
    }
    const re = {
            ...
            images: {
                loadImage: function (e, t, s, i, n, a) {
                    ...
                    T(e).parent("picture")[0] || (e.complete && n) ? l() : t ? ((o = new r.Image()), (o.onload = l), (o.onerror = l), i && (o.sizes = i), s && (o.srcset = s), t && (o.src = t)) : l();
                },
    ...
    class le {
        constructor() {
            ...
            const r = {};
            a.modules.forEach((e) => {
                e({ swiper: a, extendParams: ae(t, r), on: a.on.bind(a), once: a.once.bind(a), off: a.off.bind(a), emit: a.emit.bind(a) });
            });
            const o = O({}, ne, r);
            return (
                (a.params = O({}, o, oe, t)),
    ...
    function pe(e) {
        ...
        function c() {
            ...
            if (((t.params.navigation = ce(t, t.originalParams.navigation, t.params.navigation, { nextEl: "swiper-button-next", prevEl: "swiper-button-prev" })), !e.nextEl && !e.prevEl)) return;
            const s = a(e.nextEl),
                i = a(e.prevEl);
    ...
    function he(e) {
        ...
        function c() {
            ...
            if (("fraction" === s.type && (a.find(ue(s.currentClass)).text(s.formatFractionCurrent(c + 1)), a.find(ue(s.totalClass)).text(s.formatFractionTotal(p))), "progressbar" === s.type)) {
                let e;
                e = s.progressbarOpposite ? (t.isHorizontal() ? "vertical" : "horizontal") : t.isHorizontal() ? "horizontal" : "vertical";
                const i = (c + 1) / p;
                let n = 1,
                    r = 1;
                "horizontal" === e ? (n = i) : (r = i), a.find(ue(s.progressbarFillClass)).transform(`translate3d(0,0,0) scaleX(${n}) scaleY(${r})`).transition(t.params.speed);
            }
        ...
        function u() {
            t.params.pagination = ce(t, t.originalParams.pagination, t.params.pagination, { el: "swiper-pagination" });
            const e = t.params.pagination;
            if (!e.el) return;
            let s = T(e.el);
            0 !== s.length &&
                (t.params.uniqueNavElements && "string" == typeof e.el && s.length > 1 && ((s = t.$el.find(e.el)), s.length > 1 && (s = s.filter((e) => T(e).parents(".swiper")[0] === t.el))),
        ...
        i("init", () => {
            ...
            i("click", (e, s) => {
                const i = s.target,
                    { $el: a } = t.pagination;
                if (t.params.pagination.el && t.params.pagination.hideOnClick && a && a.length > 0 && !T(i).hasClass(t.params.pagination.bulletClass)) {
        ...
        (s.autoplay = { running: !1, paused: !1 }),
            ...
            n("init", () => {
                if (s.params.autoplay.enabled) {
                    o();
                    m().addEventListener("visibilitychange", c), s.params.autoplay.pauseOnMouseEnter && (s.$el.on("mouseenter", u), s.$el.on("mouseleave", h));
                }
            }),
    ...
    window.addEventListener("load", function (e) {
        document.querySelector(".block-1__slider") &&
            ...
            document.querySelector(".block-10__slider-bottom") &&
                new de(".block-10__slider-bottom", {
                    modules: [me],
                    observer: !0,
                    observeParents: !0,
                    slidesPerView: 5,
            ...
            document.querySelector(".bitum-page-block-10__slider") &&
                new de(".bitum-page-block-10__slider", {
                    modules: [pe, me],
                    observer: !0,
                    observeParents: !0,
                    slidesPerView: 2,
                    ...
                    freeMode: !0,
                    loopAdditionalSlides: 50,
                    autoplay: { reverseDirection: !0, delay: 1e3, disableOnInteraction: !1, stopOnLastSlide: !1, pauseOnMouseEnter: !0 },
            ...
            t.length &&
                ...
                document.body.addEventListener("focusin", function (e) {
                    ...
                    ("INPUT" !== t.tagName && "TEXTAREA" !== t.tagName) ||
                        (t.dataset.placeholder && (t.placeholder = ""), t.hasAttribute("data-no-focus-classes") || (t.classList.add("_form-focus"), t.parentElement.classList.add("_form-focus")), c.removeError(t));
                }),
