(() => {
    ...
    let c = (e, t = !1, s = 500, i = 0) => {
        ...
        if (n) {
            let r = "",
                l = 0;
            t && ((r = "header.header"), (l = document.querySelector(r).offsetHeight));
            let d = { speedAsDuration: !0, speed: s, header: r, offset: i, easing: "easeOutQuad" };
            if ((document.documentElement.classList.contains("menu-open") && (a(), document.documentElement.classList.remove("menu-open")), "undefined" != typeof SmoothScroll)) new SmoothScroll().animateScroll(n, "", d);
            else {
    ...
    function h(e = {}, t = {}) {
        Object.keys(t).forEach((s) => {
            void 0 === e[s] ? (e[s] = t[s]) : u(t[s]) && u(e[s]) && Object.keys(t[s]).length > 0 && h(e[s], t[s]);
        });
    }
    const m = {
        body: {},
    ...
    function E(e) {
        return function (...t) {
            if (void 0 === t[0]) {
                for (let t = 0; t < this.length; t += 1) C.indexOf(e) < 0 && (e in this[t] ? this[t][e]() : S(this[t]).trigger(e));
                return this;
            }
            return this.on(e, ...t);
        };
    ...
    const T = {
        ...
        append: function (...e) {
            ...
            for (let i = 0; i < e.length; i += 1) {
                ...
                for (let e = 0; e < this.length; e += 1)
                    ...
                    } else if (t instanceof b) for (let s = 0; s < t.length; s += 1) this[e].appendChild(t[s]);
        ...
        prepend: function (e) {
            ...
            for (s = 0; s < this.length; s += 1)
                ...
                } else if (e instanceof b) for (i = 0; i < e.length; i += 1) this[s].insertBefore(e[i], this[s].childNodes[0]);
        ...
        for (let s = 1; s < arguments.length; s += 1) {
            ...
            if (null != i && !O(i)) {
                ...
                for (let t = 0, n = s.length; t < n; t += 1) {
                    ...
                    void 0 !== a && a.enumerable && (P(e[n]) && P(i[n]) ? (i[n].__swiper__ ? (e[n] = i[n]) : A(e[n], i[n])) : !P(e[n]) && P(i[n]) ? ((e[n] = {}), i[n].__swiper__ ? (e[n] = i[n]) : A(e[n], i[n])) : (e[n] = i[n]));
                }
            }
        }
        return e;
                ...
                (B = (function (e) {
                    ...
                    return (
                        !c &&
                            ...
                            ((c = a.match(/(Version)\/([\d.]+)/)), c || (c = [0, 1, "13_0_0"]), (m = !1)),
    ...
    const N = {
        ...
        updateSlides: function () {
            ...
            "string" == typeof w && w.indexOf("%") >= 0 && (w = (parseFloat(w.replace("%", "")) / 100) * a),
                ...
                i.centeredSlides && i.cssMode && ($(e.wrapperEl, "--swiper-centered-offset-before", ""), $(e.wrapperEl, "--swiper-centered-offset-after", ""));
            ...
            for (let n = 0; n < p; n += 1) {
                ...
                if ((E && e.grid.updateSlide(n, r, p, t), "none" !== r.css("display"))) {
                    if ("auto" === i.slidesPerView) {
                        ...
                        if ((o && (r[0].style.transform = "none"), l && (r[0].style.webkitTransform = "none"), i.roundLengths)) T = e.isHorizontal() ? r.outerWidth(!0) : r.outerHeight(!0);
                        else {
                            const e = s(a, "width"),
                                t = s(a, "padding-left"),
                                i = s(a, "padding-right"),
                        ...
                        o && (r[0].style.transform = o), l && (r[0].style.webkitTransform = l), i.roundLengths && (T = Math.floor(T));
                    } else (T = (a - (i.slidesPerView - 1) * w) / i.slidesPerView), i.roundLengths && (T = Math.floor(T)), c[n] && (c[n].style[t("width")] = `${T}px`);
                    c[n] && (c[n].swiperSlideSize = T),
                        ...
                        i.centeredSlides
                            ? ((y = y + T / 2 + S / 2 + w),
                              ...
                              h.push(y))
                            : (i.roundLengths && (y = Math.floor(y)), (C - Math.min(e.params.slidesPerGroupSkip, C)) % e.params.slidesPerGroup == 0 && u.push(y), h.push(y), (y = y + T + w)),
                        (e.virtualSize += T + w),
                        (S = T),
                        (C += 1);
                }
            ...
            if (
                ...
                r && o && ("slide" === i.effect || "coverflow" === i.effect) && n.css({ width: `${e.virtualSize + i.spaceBetween}px` }),
            ...
            if ((Object.assign(e, { slides: c, snapGrid: u, slidesGrid: h, slidesSizesGrid: m }), i.centeredSlides && i.cssMode && !i.centeredSlidesBounds)) {
                $(e.wrapperEl, "--swiper-centered-offset-before", -u[0] + "px"), $(e.wrapperEl, "--swiper-centered-offset-after", e.size / 2 - m[m.length - 1] / 2 + "px");
        ...
        updateSlidesProgress: function (e) {
            ...
            for (let e = 0; e < i.length; e += 1) {
                ...
                ((p >= 0 && p < t.size - 1) || (u > 1 && u <= t.size) || (p <= 0 && u >= t.size)) && (t.visibleSlides.push(o), t.visibleSlidesIndexes.push(e), i.eq(e).addClass(s.slideVisibleClass)),
                    (o.progress = n ? -d : d),
        ...
        updateSlidesClasses: function () {
            ...
            t.removeClass(`${s.slideActiveClass} ${s.slideNextClass} ${s.slidePrevClass} ${s.slideDuplicateActiveClass} ${s.slideDuplicateNextClass} ${s.slideDuplicatePrevClass}`),
                (o = r ? e.$wrapperEl.find(`.${s.slideClass}[data-swiper-slide-index="${n}"]`) : t.eq(n)),
        ...
        updateActiveIndex: function (e) {
            const t = this,
                ...
                { slidesGrid: i, snapGrid: n, params: a, activeIndex: r, realIndex: o, snapIndex: l } = t;
            let d,
                c = e;
            if (void 0 === c) {
    ...
    const H = {
        ...
        setTranslate: function (e, t) {
            const s = this,
                { rtlTranslate: i, params: n, $wrapperEl: a, wrapperEl: r, progress: o } = s;
            let l,
                d = 0,
                c = 0;
        ...
        translateTo: function (e, t, s, i, n) {
            ...
            if (((c = i && e > l ? l : i && e < d ? d : e), a.updateProgress(c), r.cssMode)) {
                ...
                if (0 === t) o[e ? "scrollLeft" : "scrollTop"] = -c;
                    ...
                    if (!a.support.smoothScroll) return M({ swiper: a, targetPosition: -c, side: e ? "left" : "top" }), !0;
    ...
    const j = {
        slideTo: function (e, t, s, i, n) {
            ...
            let r = e;
            r < 0 && (r = 0);
            const { params: o, snapGrid: l, slidesGrid: d, previousIndex: c, activeIndex: p, rtlTranslate: u, wrapperEl: h, enabled: m } = a;
            ...
            let b;
            if (((b = r > p ? "next" : r < p ? "prev" : "reset"), (u && -v === a.translate) || (!u && v === a.translate)))
                return a.updateActiveIndex(r), o.autoHeight && a.updateAutoHeight(), a.updateSlidesClasses(), "slide" !== o.effect && a.setTranslate(v), "reset" !== b && (a.transitionStart(s, b), a.transitionEnd(s, b)), !1;
            if (o.cssMode) {
                const e = a.isHorizontal(),
                    s = u ? v : -v;
                if (0 === t) {
                    ...
                    if (!a.support.smoothScroll) return M({ swiper: a, targetPosition: s, side: e ? "left" : "top" }), !0;
        ...
        slidePrev: function (e, t, s) {
            void 0 === e && (e = this.params.speed), void 0 === t && (t = !0);
            const i = this,
                { params: n, animating: a, snapGrid: r, slidesGrid: o, rtlTranslate: l, enabled: d } = i;
            if (!d) return i;
            if (n.loop) {
            ...
            if (
                (void 0 !== h &&
                    ((m = o.indexOf(h)), m < 0 && (m = i.activeIndex - 1), "auto" === n.slidesPerView && 1 === n.slidesPerGroup && n.slidesPerGroupAuto && ((m = m - i.slidesPerViewDynamic("previous", !0) + 1), (m = Math.max(m, 0)))),
    ...
    const F = {
        loopCreate: function () {
            ...
            for (let e = r.length - 1; e >= 0; e -= 1) n.prepend(x(r[e].cloneNode(!0)).addClass(s.slideDuplicateClass));
        },
        loopFix: function () {
            const e = this;
            e.emit("beforeLoopFix");
            const { activeIndex: t, slides: s, loopedSlides: i, allowSlidePrev: n, allowSlideNext: a, snapGrid: r, rtlTranslate: o } = e;
            let l;
    ...
    function R(e) {
        ...
        !!a.noSwipingClass && "" !== a.noSwipingClass && l.target && l.target.shadowRoot && e.path && e.path[0] && (d = x(e.path[0]));
        ...
        if (
            ...
            let e = !0;
            d.is(n.focusableElements) && ((e = !1), "SELECT" === d[0].nodeName && (n.isTouched = !1)), s.activeElement && x(s.activeElement).is(n.focusableElements) && s.activeElement !== d[0] && s.activeElement.blur();
    ...
    function Y(e) {
        ...
        if (!s.allowTouchMove) return x(l.target).is(i.focusableElements) || (s.allowClick = !1), void (i.isTouched && (Object.assign(a, { startX: c, startY: p, currentX: c, currentY: p }), (i.touchStartTime = k())));
        ...
        if (void 0 === i.isScrolling) {
            ...
            (s.isHorizontal() && a.currentY === a.startY) || (s.isVertical() && a.currentX === a.startX)
                ? (i.isScrolling = !1)
                : u * u + h * h >= 25 && ((e = (180 * Math.atan2(Math.abs(h), Math.abs(u))) / Math.PI), (i.isScrolling = s.isHorizontal() ? e > n.touchAngle : 90 - e > n.touchAngle));
        }
        ...
        (a.diff = m), (m *= n.touchRatio), r && (m = -m), (s.swipeDirection = m > 0 ? "prev" : "next"), (i.currentTranslate = m + i.startTranslate);
        let g = !0,
            v = n.resistanceRatio;
        if (
    ...
    function X(e) {
        ...
        if (c > i.longSwipesMs) {
            ...
            "next" === t.swipeDirection && (g >= i.longSwipesRatio ? t.slideTo(i.rewind && t.isEnd ? m : u + v) : t.slideTo(u)),
                "prev" === t.swipeDirection && (g > 1 - i.longSwipesRatio ? t.slideTo(u + v) : null !== f && g < 0 && Math.abs(g) > i.longSwipesRatio ? t.slideTo(f) : t.slideTo(u));
        } else {
            ...
            t.navigation && (l.target === t.navigation.nextEl || l.target === t.navigation.prevEl)
                ? l.target === t.navigation.nextEl
                    ? t.slideTo(u + v)
                    : t.slideTo(u)
                : ("next" === t.swipeDirection && t.slideTo(null !== m ? m : u + v), "prev" === t.swipeDirection && t.slideTo(null !== f ? f : u));
        }
    }
    function U() {
        const e = this,
    ...
    const ee = (e, t) => {
        const s = f(),
            { params: i, touchEvents: n, el: a, wrapperEl: r, device: o, support: l } = e,
            d = !!i.nested,
            c = "on" === t ? "addEventListener" : "removeEventListener",
            p = t;
        if (l.touch) {
            const t = !("touchstart" !== n.start || !l.passiveListener || !i.passiveListeners) && { passive: !0, capture: !1 };
            a[c](n.start, e.onTouchStart, t), a[c](n.move, e.onTouchMove, l.passiveListener ? { passive: !1, capture: d } : d), a[c](n.end, e.onTouchEnd, t), n.cancel && a[c](n.cancel, e.onTouchEnd, t);
        ...
        (i.preventClicks || i.preventClicksPropagation) && a[c]("click", e.onClick, !0),
            ...
            i.updateOnWindowResize ? e[p](o.ios || o.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", U, !0) : e[p]("observerUpdate", U, !0);
    };
    const te = {
    ...
    const ie = {
        setBreakpoint: function () {
            ...
            d && !c
                ...
                : !d &&
                  c &&
                  (a.addClass(`${n.containerModifierClass}grid`), ((l.grid.fill && "column" === l.grid.fill) || (!l.grid.fill && "column" === n.grid.fill)) && a.addClass(`${n.containerModifierClass}grid-column`), e.emitContainerClasses()),
        ...
        return function (s) {
            ...
            "object" == typeof n && null !== n
                ? (["navigation", "pagination", "scrollbar"].indexOf(i) >= 0 && !0 === e[i] && (e[i] = { auto: !0 }),
                  i in e && "enabled" in n ? (!0 === e[i] && (e[i] = { enabled: !0 }), "object" != typeof e[i] || "enabled" in e[i] || (e[i].enabled = !0), e[i] || (e[i] = { enabled: !1 }), A(t, s)) : A(t, s))
                : A(t, s);
        };
    }
    const oe = {
            ...
            transition: {
                ...
                transitionStart: function (e, t) {
                    ...
                    const s = this,
                        { params: i } = s;
                    i.cssMode || (i.autoHeight && s.updateAutoHeight(), W({ swiper: s, runCallbacks: e, direction: t, step: "Start" }));
                },
                transitionEnd: function (e, t) {
                    void 0 === e && (e = !0);
                    const s = this,
                        { params: i } = s;
                    (s.animating = !1), i.cssMode || (s.setTransition(0), W({ swiper: s, runCallbacks: e, direction: t, step: "End" }));
                },
            },
            slide: j,
            loop: F,
            ...
            images: {
                loadImage: function (e, t, s, i, n, a) {
                    ...
                    x(e).parent("picture")[0] || (e.complete && n) ? l() : t ? ((o = new r.Image()), (o.onload = l), (o.onerror = l), i && (o.sizes = i), s && (o.srcset = s), t && (o.src = t)) : l();
                },
    ...
    class de {
        constructor() {
            ...
            if ((1 === i.length && i[0].constructor && "Object" === Object.prototype.toString.call(i[0]).slice(8, -1) ? (t = i[0]) : ([e, t] = i), t || (t = {}), (t = A({}, t)), e && !t.el && (t.el = e), t.el && x(t.el).length > 1)) {
                const e = [];
                return (
                    x(t.el).each((s) => {
                        const i = A({}, t, { el: s });
            ...
            const r = {};
            a.modules.forEach((e) => {
                e({ swiper: a, extendParams: re(t, r), on: a.on.bind(a), once: a.once.bind(a), off: a.off.bind(a), emit: a.emit.bind(a) });
            });
            const o = A({}, ae, r);
            return (
                (a.params = A({}, o, le, t)),
        ...
        slidesPerViewDynamic(e, t) {
            ...
            const { params: s, slides: i, slidesGrid: n, slidesSizesGrid: a, size: r, activeIndex: o } = this;
            let l = 1;
            if (s.centeredSlides) {
                let e,
    ...
    function ue(e) {
        ...
        function a(e) {
            let s;
            return e && ((s = x(e)), t.params.uniqueNavElements && "string" == typeof e && s.length > 1 && 1 === t.$el.find(e).length && (s = t.$el.find(e))), s;
        }
        function r(e, s) {
        ...
        function c() {
            ...
            if (((t.params.navigation = pe(t, t.originalParams.navigation, t.params.navigation, { nextEl: "swiper-button-next", prevEl: "swiper-button-prev" })), !e.nextEl && !e.prevEl)) return;
            const s = a(e.nextEl),
                i = a(e.prevEl);
    ...
    function me(e) {
        ...
        function c() {
            ...
            if (
                ...
                if (
                    (s.dynamicBullets &&
                        ...
                        s.dynamicMainBullets > 1 && void 0 !== t.previousIndex && ((o += c - (t.previousIndex - t.loopedSlides || 0)), o > s.dynamicMainBullets - 1 ? (o = s.dynamicMainBullets - 1) : o < 0 && (o = 0)),
                        (n = Math.max(c - o, 0)),
            ...
            if (("fraction" === s.type && (a.find(he(s.currentClass)).text(s.formatFractionCurrent(c + 1)), a.find(he(s.totalClass)).text(s.formatFractionTotal(p))), "progressbar" === s.type)) {
                let e;
                e = s.progressbarOpposite ? (t.isHorizontal() ? "vertical" : "horizontal") : t.isHorizontal() ? "horizontal" : "vertical";
                const i = (c + 1) / p;
                let n = 1,
                    r = 1;
                "horizontal" === e ? (n = i) : (r = i), a.find(he(s.progressbarFillClass)).transform(`translate3d(0,0,0) scaleX(${n}) scaleY(${r})`).transition(t.params.speed);
            }
            "custom" === s.type && s.renderCustom ? (a.html(s.renderCustom(t, c + 1, p)), n("paginationRender", a[0])) : n("paginationUpdate", a[0]),
        ...
        function p() {
            ...
            "fraction" === e.type && ((a = e.renderFraction ? e.renderFraction.call(t, e.currentClass, e.totalClass) : `<span class="${e.currentClass}"></span> / <span class="${e.totalClass}"></span>`), i.html(a)),
                "progressbar" === e.type && ((a = e.renderProgressbar ? e.renderProgressbar.call(t, e.progressbarFillClass) : `<span class="${e.progressbarFillClass}"></span>`), i.html(a)),
                "custom" !== e.type && n("paginationRender", t.pagination.$el[0]);
        }
        function u() {
            t.params.pagination = pe(t, t.originalParams.pagination, t.params.pagination, { el: "swiper-pagination" });
            const e = t.params.pagination;
            if (!e.el) return;
            let s = x(e.el);
            0 !== s.length &&
                (t.params.uniqueNavElements && "string" == typeof e.el && s.length > 1 && ((s = t.$el.find(e.el)), s.length > 1 && (s = s.filter((e) => x(e).parents(".swiper")[0] === t.el))),
        ...
        i("init", () => {
            ...
            i("click", (e, s) => {
                const i = s.target,
                    { $el: a } = t.pagination;
                if (t.params.pagination.el && t.params.pagination.hideOnClick && a && a.length > 0 && !x(i).hasClass(t.params.pagination.bulletClass)) {
    ...
    function fe(e) {
            ...
            e.attr("data-swiper-autoplay") && (i = e.attr("data-swiper-autoplay") || s.params.autoplay.delay),
                ...
                (t = L(() => {
                    ...
                    s.params.autoplay.reverseDirection
                        ? s.params.loop
                            ? (s.loopFix(), (e = s.slidePrev(s.params.speed, !0, !0)), a("autoplay"))
                            : s.isBeginning
                            ? s.params.autoplay.stopOnLastSlide
                                ? l()
                                : ((e = s.slideTo(s.slides.length - 1, s.params.speed, !0, !0)), a("autoplay"))
                            : ((e = s.slidePrev(s.params.speed, !0, !0)), a("autoplay"))
                        : s.params.loop
                        ? (s.loopFix(), (e = s.slideNext(s.params.speed, !0, !0)), a("autoplay"))
                        : s.isEnd
                        ? s.params.autoplay.stopOnLastSlide
                            ? l()
        ...
        function o() {
            return void 0 === t && !s.autoplay.running && ((s.autoplay.running = !0), a("autoplayStart"), r(), !0);
        }
        function l() {
        ...
        (s.autoplay = { running: !1, paused: !1 }),
            ...
            n("init", () => {
                if (s.params.autoplay.enabled) {
                    o();
                    f().addEventListener("visibilitychange", c), s.params.autoplay.pauseOnMouseEnter && (s.$el.on("mouseenter", u), s.$el.on("mouseleave", h));
                }
            }),
            ...
            n("destroy", () => {
                s.$el.off("mouseenter", u), s.$el.off("mouseleave", h), s.autoplay.running && l();
                f().removeEventListener("visibilitychange", c);
            }),
            Object.assign(s.autoplay, { pause: d, run: r, start: o, stop: l });
    }
    window.addEventListener("load", function (e) {
        document.querySelector(".block-1__slider") &&
            new ce(".block-1__slider", {
                modules: [me, fe],
                observer: !0,
                observeParents: !0,
                slidesPerView: 1,
                ...
                pagination: { el: ".block-1__slider .block-1__pagination", clickable: !0 },
                on: {},
            }),
            document.querySelector(".block-4-tabs__slider") &&
                new ce(".block-4-tabs__slider", {
                    modules: [fe],
                    observer: !0,
                    observeParents: !0,
                    slidesPerView: 3,
                    ...
                    pagination: { el: ".block-4-tabs__controlls .block-4-tabs__pagination", clickable: !0 },
                    navigation: { prevEl: ".block-4-tabs__slider .block-4-tabs__prev", nextEl: ".block-4-tabs__slider .block-4-tabs__next" },
                    breakpoints: { 320: { slidesPerView: 1, spaceBetween: 20 }, 650: { slidesPerView: 2, spaceBetween: 10 }, 992: { slidesPerView: 2, spaceBetween: 10 }, 1300: { slidesPerView: 3, spaceBetween: 19 } },
                    on: {},
                }),
            document.querySelector(".block-8__slider") &&
                new ce(".block-8__slider", {
                    modules: [fe],
                    observer: !0,
                    observeParents: !0,
                    slidesPerView: 7,
                    ...
                    watchOverflow: !0,
                    freeMode: !0,
                    autoplay: { delay: 0, disableOnInteraction: !1, stopOnLastSlide: !1, pauseOnMouseEnter: !0 },
                    breakpoints: { 320: { slidesPerView: 3 }, 480: { slidesPerView: 4 }, 768: { slidesPerView: 5 }, 1300: { slidesPerView: 7 } },
                    on: {},
                }),
            document.querySelector(".block-9__slider") &&
                new ce(".block-9__slider", {
                    modules: [fe],
                    observer: !0,
                    observeParents: !0,
                    slidesPerView: 4,
                    ...
                    loop: !0,
                    watchOverflow: !0,
                    autoplay: { reverseDirection: !0, delay: 4e3, disableOnInteraction: !1, pauseOnMouseEnter: !0 },
                    breakpoints: {
                        320: { slidesPerView: 1, spaceBetween: 20 },
                        480: { slidesPerView: 2, spaceBetween: 20 },
                        768: { slidesPerView: 3, spaceBetween: 20 },
                        992: { slidesPerView: 4, spaceBetween: 20 },
                        1300: { slidesPerView: 4, spaceBetween: 74 },
                    },
                    on: {},
                }),
            document.querySelector(".block-10__slider-top") &&
                new ce(".block-10__slider-top", {
                    modules: [fe],
                    observer: !0,
                    observeParents: !0,
                    slidesPerView: 3,
                    ...
                    autoplay: { delay: 800, disableOnInteraction: !1, pauseOnMouseEnter: !0 },
                    breakpoints: { 320: { slidesPerView: 1 }, 480: { slidesPerView: 2 }, 1100: { slidesPerView: 3 } },
                    on: {},
                }),
            document.querySelector(".block-10__slider-bottom") &&
                new ce(".block-10__slider-bottom", {
                    modules: [fe],
                    observer: !0,
                    observeParents: !0,
                    slidesPerView: 5,
                    ...
                    initialSlide: 10,
                    autoHeight: !0,
                    autoplay: { reverseDirection: !0, delay: 800, disableOnInteraction: !1, stopOnLastSlide: !1, pauseOnMouseEnter: !0 },
                    breakpoints: { 320: { slidesPerView: 2 }, 480: { slidesPerView: 3 }, 1100: { slidesPerView: 4 } },
                    on: {},
                }),
            document.querySelector(".bitum-page-block-10__slider") &&
                new ce(".bitum-page-block-10__slider", {
                    modules: [ue, fe],
                    observer: !0,
                    observeParents: !0,
                    slidesPerView: 2,
                    ...
                    freeMode: !0,
                    loopAdditionalSlides: 50,
                    autoplay: { delay: 1e3, disableOnInteraction: !1, stopOnLastSlide: !1, pauseOnMouseEnter: !0 },
                    breakpoints: { 320: { slidesPerView: 1 }, 650: { slidesPerView: 2 } },
                    navigation: { prevEl: ".bitum-page-block-10__arrows .bitum-page-block-10__arrow_prev", nextEl: ".bitum-page-block-10__arrows .bitum-page-block-10__arrow_next" },
                    on: {},
                }),
            document.querySelector(".bitum-fas-page-block-9__slider") &&
                new ce(".bitum-fas-page-block-9__slider", {
                    modules: [ue, fe],
                    observer: !0,
                    observeParents: !0,
                    slidesPerView: 2,
                    ...
                    autoplay: { delay: 1e3, disableOnInteraction: !1, stopOnLastSlide: !1, pauseOnMouseEnter: !0 },
                    breakpoints: { 320: { slidesPerView: 1 }, 650: { slidesPerView: 2 } },
                    navigation: { prevEl: ".bitum-fas-page-block-9__arrows .bitum-fas-page-block-9__arrow_prev", nextEl: ".bitum-fas-page-block-9__arrows .bitum-fas-page-block-9__arrow_next" },
                    on: {},
                }),
            document.querySelector(".bitum-pg-page-block-8__slider") &&
                new ce(".bitum-pg-page-block-8__slider", {
                    modules: [ue, fe],
                    observer: !0,
                    observeParents: !0,
                    slidesPerView: 2,
                    ...
                    autoplay: { delay: 1e3, disableOnInteraction: !1, stopOnLastSlide: !1, pauseOnMouseEnter: !0 },
                    breakpoints: { 320: { slidesPerView: 1 }, 650: { slidesPerView: 2 } },
                    navigation: { prevEl: ".bitum-pg-page-block-8__arrows .bitum-pg-page-block-8__arrow_prev", nextEl: ".bitum-pg-page-block-8__arrows .bitum-pg-page-block-8__arrow_next" },
                    on: {},
                }),
            document.querySelector(".news-page-block-2__slider") &&
                new ce(".news-page-block-2__slider", {
                    modules: [fe],
                    observer: !0,
                    observeParents: !0,
                    slidesPerView: 3,
                    ...
                    loopAdditionalSlides: 50,
                    autoplay: { delay: 1e3, disableOnInteraction: !1, stopOnLastSlide: !1, pauseOnMouseEnter: !0 },
                    breakpoints: { 320: { slidesPerView: 1 }, 500: { slidesPerView: 2 }, 768: { slidesPerView: 3 } },
                    on: {},
                }),
            document.querySelector(".mails-page__slider") &&
                new ce(".mails-page__slider", {
                    modules: [fe],
                    observer: !0,
                    observeParents: !0,
                    slidesPerView: 4,
                    ...
                    loopAdditionalSlides: 50,
                    autoplay: { delay: 1e3, disableOnInteraction: !1, stopOnLastSlide: !1, pauseOnMouseEnter: !0 },
                    breakpoints: { 320: { slidesPerView: 1, spaceBetween: 15 }, 600: { slidesPerView: 2, spaceBetween: 15 }, 900: { slidesPerView: 3, spaceBetween: 15 }, 1200: { slidesPerView: 4 } },
                    on: {},
                });
    });
    e.watcher = new (class {
        ...
        scrollWatcherIntersecting(e, t) {
            e.isIntersecting
                ? (!t.classList.contains("_watcher-view") && t.classList.add("_watcher-view"), this.scrollWatcherLogging(`Я вижу ${t.classList}, добавил класс _watcher-view`))
                : (t.classList.contains("_watcher-view") && t.classList.remove("_watcher-view"), this.scrollWatcherLogging(`Я не вижу ${t.classList}, убрал класс _watcher-view`));
        }
    ...
    const be = (e) => {
            let t = e.target;
            for (; !(null === t || (t.classList && t.classList.contains("fs--scrollable"))); ) t = t.parentNode;
            return t;
        },
        we = (e) => {
            document.addEventListener("touchstart", (e) =>
                ((e, t) => {
                    ...
                    if (s) {
                        ...
                        const t = s.scrollHeight,
                            i = s.clientHeight;
                        (s.dataset.fsDelta = e.touches[0].clientY), i === t && (s.dataset.fsScrollable = "true");
                    }
                })(e)
            ),
                document.addEventListener("touchmove", (t) =>
                    ((e, t) => {
                        if (!t.getState()) {
                            const t = be(e);
                            if (t)
                                if ("true" === t.dataset.fsScrollable) e.preventDefault();
                                else {
                                    const s = t.scrollTop,
                                        i = t.scrollHeight,
                                        n = s + t.offsetHeight,
                                        a = parseFloat(t.dataset.fsDelta),
                                        r = e.touches[0].clientY;
                                    s <= 0 ? a < r && e.preventDefault() : n >= i && a > r && e.preventDefault();
                                }
                        }
                    })(t, e)
                ),
                document.addEventListener("touchend", (e) =>
                    ((e, t) => {
                        const s = be(e);
                        s && (s.dataset.fsScrollable = "false");
                    })(e)
                );
        };
    ...
    new (class {
        constructor() {
            (this.state = !0), we(this);
        }
        getState() {
            return this.state;
        }
        hide() {
            const e = this.getCurrentWidth();
            (document.body.style.overflow = "hidden"), (document.body.style.paddingRight = e + "px"), (this.state = !1);
        }
        show() {
            (document.body.style.overflow = ""), (document.body.style.paddingRight = ""), (this.state = !0);
        }
        toggle() {
            this.getState() ? this.hide() : this.show();
        }
        getWidth() {
    ...
    (window.FLS = !0),
        ...
        (function () {
            ...
            if (e.length > 0) {
                ...
                function a(e, t = !1) {
                    e.forEach((e) => {
                        (e = t ? e.item : e), t.matches || !t ? (e.classList.add("_spoller-init"), r(e), e.addEventListener("click", o)) : (e.classList.remove("_spoller-init"), r(e, !1), e.removeEventListener("click", o));
                    });
                }
                function r(e, t = !0) {
                ...
                function o(e) {
                    ...
                    if (t.closest("[data-spoller]")) {
                        const n = t.closest("[data-spoller]"),
                            ...
                            o = a.dataset.spollersSpeed ? parseInt(a.dataset.spollersSpeed) : 500;
                    ...
                    (n = Array.from(n).filter((t) => t.closest("[data-tabs]") === e)),
                        ...
                        n.forEach((e, n) => {
                            ...
                            t[n].classList.contains("_tab-active")
                                ? (r ? i(e, r) : (e.hidden = !1), o && !e.closest(".popup") && ((l = (l = `tab-${a}-${n}`) ? `#${l}` : window.location.href.split("#")[0]), history.pushState("", "", l)))
                                : r
                                ? s(e, r)
                                : (e.hidden = !0);
                        });
            ...
            t.length &&
                ...
                document.body.addEventListener("focusin", function (e) {
                    ...
                    ("INPUT" !== t.tagName && "TEXTAREA" !== t.tagName) ||
                        (t.dataset.placeholder && (t.placeholder = ""), t.hasAttribute("data-no-focus-classes") || (t.classList.add("_form-focus"), t.parentElement.classList.add("_form-focus")), p.removeError(t));
                }),
        ...
        (function (t = { validate: !0 }) {
            ...
            async function i(e, t) {
                if (0 === (e.hasAttribute("data-no-validate") ? 0 : p.getErrors(e))) {
                    if (e.hasAttribute("data-ajax")) {
                        ...
                        const r = await fetch(s, { method: i, body: a });
                        if (r.ok) {
                            await r.json();
                ...
                clearTimeout(n),
                    o >= i
                        ? (!e.classList.contains("_header-scroll") && e.classList.add("_header-scroll"),
                          t &&
                              (o > a ? e.classList.contains("_header-show") && e.classList.remove("_header-show") : !e.classList.contains("_header-show") && e.classList.add("_header-show"),
                              (n = setTimeout(() => {
