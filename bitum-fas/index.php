					...
					<ul data-spollers class="bitum-fas-page-block-6__list">
						<li class="bitum-fas-page-block-6__item">
							...
							<div class="bitum-fas-page-block-6__spoller">
								<div class="bitum-fas-page-block-6__spoller-image"><img src="/img/bitum-fas-page/block-6/1.jpg"
										alt="Плавление фасованных битумных материалов"></div>
						...
						<li class="bitum-fas-page-block-6__item">
							...
							<div class="bitum-fas-page-block-6__spoller">
								<div class="bitum-fas-page-block-6__spoller-image bitum-fas-page-block-6__spoller-image_02"><img
										src="/img/bitum-fas-page/block-6/2.jpg" alt="Распаковка контейнеров"></div>
								<div class="bitum-fas-page-block-6__spoller-text">
				...
				<div class="bitum-fas-page-block-8__container">
					...
					<div class="bitum-fas-page-block-8__items">
						<div class="bitum-fas-page-block-8__item">
							<video class="bitum-fas-page-block-8__video" preload="metadata" controls
					...
					<div class="bitum-fas-page-block-9__slider swiper">
						<div class="bitum-fas-page-block-9__wrapper swiper-wrapper">
							<a href="#" class="bitum-fas-page-block-9__slide swiper-slide">
								<img src="/img/bitum-fas-page/block-9/1.jpg" alt="Битум фасованный">
							</a>
							<a href="#" class="bitum-fas-page-block-9__slide swiper-slide">
								<img src="/img/bitum-fas-page/block-9/2.jpg" alt="Битум фасованный">
							</a>
							<a href="#" class="bitum-fas-page-block-9__slide swiper-slide">
								<img src="/img/bitum-fas-page/block-9/1.jpg" alt="Битум фасованный">
							</a>
