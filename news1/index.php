...
?>
		<main class="news-page">
			<section class="news-page__block-1 news-page-block-1">
				<div class="news-page-block-1__container">
					<h1 class="news-page-block-1__title">Название статьи</h1>
					<div class="news-page-block-1__info">
					...
					<div class="news-page-block-1__text">
						<p>
							...
							только методом политического участия и указаны как претенденты на роль ключевых факторов. Но акционеры
							крупнейших компаний функционально разнесены на независимые элементы. Активно развивающиеся страны
							третьего мира могут быть превращены в посмешище, хотя само их существование приносит несомненную пользу
							обществу.
						</p>
						<p>
							В рамках спецификации современных стандартов, представители современных социальных резервов являются
			...
			<section class="news-page__block-2 news-page-block-2">
				<div class="news-page-block-2__container">
					<h2 data-watch data-watch-once class="news-page-block-2__title">Еще больше статей</h2>
