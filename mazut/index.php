		...
		Array(
			...
			<section class="mazut-page__block-6 mazut-page-block-6">
				<div class="mazut-page-block-6__container">
					...
					<div class="mazut-page-block-6__passport"><a href="http://rosoil.stt-corp.ru/passports/" target="_blank" class="mazut-page-block-6__passport-link"><span>Паспорт
								качества продукции</span></a></div>
				</div>
			</section>
